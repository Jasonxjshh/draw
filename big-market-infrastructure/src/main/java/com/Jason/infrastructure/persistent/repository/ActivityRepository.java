...
import com.Jason.domain.activity.event.ActivitySkuStockZeroMessageEvent;
...
public class ActivityRepository implements IActivityRepository {
    ...
    public ActivityAccountEntity queryActivityAccountEntity(Long activityId, String userId) {
        ...
        // 2. 查询月账户额度
        raffleActivityAccountMonth = raffleActivityAccountMonthDao.queryActivityAccountMonthByUserId(RaffleActivityAccountMonth.builder()
                .activityId(activityId)
                .userId(userId)
        ...
        raffleActivityAccountDay = raffleActivityAccountDayDao.queryActivityAccountDayByUserId(RaffleActivityAccountDay.builder()
                .activityId(activityId)
                .userId(userId)
    ...
    public void doSaveNoPayOrder(CreateQuotaOrderAggregate createOrderAggregate) {
        RLock lock = redisService.getLock(Constants.RedisKey.ACTIVITY_ACCOUNT_LOCK + createOrderAggregate.getUserId() + Constants.UNDER_LINE + createOrderAggregate.getActivityId());
        try {
