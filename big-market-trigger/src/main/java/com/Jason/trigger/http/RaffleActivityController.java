...
import com.Jason.domain.credit.model.valobj.TradeNameVO;
import com.Jason.domain.credit.model.valobj.TradeTypeVO;
...
public class RaffleActivityController implements IRaffleActivityService {
    ...
    public Response<ActivityDrawResponseDTO> draw(@RequestBody ActivityDrawRequestDTO request) {
        try {
            ...
            // 2. 参与活动 - 创建参与记录订单
            UserRaffleOrderEntity orderEntity = raffleActivityPartakeService.createOrder(new PartakeRaffleActivityEntity(request.getUserId(), request.getActivityId()));
